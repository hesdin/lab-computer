        ...
        <div class="main-header">
            ...
            <div class="sidebar">
                <div class="scrollbar-inner sidebar-wrapper">
                    <ul class="nav">
                        <li class="nav-item {{ (Request::is('o/dashboard')) ? 'active' : '' }}">
                            <a href="/o/dashboard">
                                <i class="fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item {{ (Request::segment(3) == 'mahasiswa') ? 'active' : '' }}">
                            <a href="/o/dashboard/mahasiswa">
                                <i class="fas fa-user"></i>
                                <p>Mahasiswa</p>
                            </a>
                        </li>
                        <li class="nav-item {{ (Request::segment(3) == 'slip') ? 'active' : '' }}">
                            <a href="/o/dashboard/slip">
                                <i class="fas fa-file"></i>
                                <p>Slip Pembayaran</p>
                            </a>
                        </li>
                        <li class="nav-item {{ (Request::segment(3) == 'bantuan') ? 'active' : '' }}">
                            <a href="/o/dashboard/bantuan">
